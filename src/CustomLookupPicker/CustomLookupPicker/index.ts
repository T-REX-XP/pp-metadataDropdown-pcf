...
export class CustomLookupPicker implements ComponentFramework.ReactControl<IInputs, IOutputs> {
    ...
    private _selectedValue?: IComboBoxOption;
    /**
     * Empty constructor.
     */
    constructor() { }
    ...
    public updateView(context: ComponentFramework.Context<IInputs>): React.ReactElement {
        const props: IMainComponentProps = {
            ...
            selectedKey: this._selectedValue?.key?.toString(),
            mask: context.parameters.mask.raw as string || undefined
        };

        this._selectedValue = {key: context.parameters.value.raw!, text:""};
        return React.createElement(
            MainComponent, props
        );
    }
    onChange = (newValue: IComboBoxOption | undefined): void => {
    ...
    public getOutputs(): IOutputs {
        ...
        const result: IOutputs = {
            value: this._selectedValue?.key?.toString()
        };
        return result;
    }
